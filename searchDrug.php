	...
	<?php
		if (isset($_POST['submit1'])) {
			...
			//Retrive data from batch and drug table using inner join by drug name
			 $search_name ="SELECT drug.d_id,drug.d_name,drug.price, batch.batch_no,batch.ex_date,batch.available_quantity FROM drug INNER JOIN batch ON drug.drug_name = batch.drug_name AND drug.drug_name = '$drug_name'";
